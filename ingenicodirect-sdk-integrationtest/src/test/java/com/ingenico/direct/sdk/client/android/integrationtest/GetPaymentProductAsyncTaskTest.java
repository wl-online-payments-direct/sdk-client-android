...
public class GetPaymentProductAsyncTaskTest extends BaseAsyncTaskTest {
    ...
    public void testGetPaymentProductAsyncTaskWithValidRequest() throws InterruptedException, CommunicationException {
        ...
        List<PaymentProductAsyncTask.PaymentProductCallListener> listeners = new ArrayList<>(1);
    ...
    private class Listener implements PaymentProductAsyncTask.OnPaymentProductCallCompleteListener, PaymentProductAsyncTask.PaymentProductCallListener {
        ...
        public void onPaymentProductCallError(ErrorResponse error) {
            signal.countDown();
            Log.w("PaymentProductTest", error.message + error.apiError);
        }
