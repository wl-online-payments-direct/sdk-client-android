...
internal object MetadataUtil {
    ...
    private const val METADATA_SCREEN_SIZE = "screenSize"
    ...
    fun getMetadata(context: Context, appIdentifier: String?, sdkIdentifier: String): Map<String, String> {
        ...
        metaData[METADATA_SCREEN_SIZE] = metrics.heightPixels.toString() + "x" + metrics.widthPixels.toString()
    ...
    private fun encode(jsonMetadata: String): String {
        return encryptionUtil.base64UrlEncode(jsonMetadata.toByteArray(StandardCharsets.UTF_8))
    }
}
