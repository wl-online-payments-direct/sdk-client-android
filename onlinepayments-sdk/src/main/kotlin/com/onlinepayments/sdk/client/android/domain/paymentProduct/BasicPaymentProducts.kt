...
class BasicPaymentProducts internal constructor(
    val paymentProducts: MutableList<BasicPaymentProduct>,
    val accountsOnFile: List<AccountOnFile>
) : Serializable {
    companion object {
        @Suppress("Unused")
        private const val serialVersionUID = 1093847562904857164L
    }
}
