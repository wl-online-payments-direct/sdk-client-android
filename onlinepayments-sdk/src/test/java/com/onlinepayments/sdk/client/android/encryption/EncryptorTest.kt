...
/**
 * Junit Testclass which tests Encryptor.encrypt function
 *
...
class EncryptorTest {
    companion object {
        ...
        private const val dummyPublicKeyString = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC2f4YBFXsT5uxNbT2EwzXos01p\n" +
        ...
        private val publicKeyResponse = PublicKeyResponse("keyId", dummyPublicKeyString)
        ...
        fun setup() {
            ...
            Whitebox.setInternalState(mockEncryptUtil, "rsaAlgorithmMode", "RSA/ECB/OAEPWithSHA-1AndMGF1Padding")
            ...
            `when`(
                mockEncryptUtil.calculateHmac(any(ByteArray::class.java), any(ByteArray::class.java))
            ).thenCallRealMethod()
            ...
            `when`(mockEncryptUtil.encryptContentEncryptionKey(any(ByteArray::class.java), any(
                PublicKey::class.java))).thenReturn(dummyByteArray)
        }
