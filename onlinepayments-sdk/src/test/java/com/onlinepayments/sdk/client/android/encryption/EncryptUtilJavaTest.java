...
public class EncryptUtilJavaTest {
    ...
    public void testEncryptPayload() {
        ...
        contentEncryptionKey = java.util.Arrays.copyOfRange(contentEncryptionKey, 0, 16);
        initializationVector = java.util.Arrays.copyOfRange(initializationVector, 0, 16);
