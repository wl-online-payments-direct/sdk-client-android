package com.ingenico.direct.sdk.client.android.communicate;
...
import com.ingenico.direct.sdk.client.android.model.PaymentProductNetworkResponse;
import com.ingenico.direct.sdk.client.android.model.api.ApiError;
import com.ingenico.direct.sdk.client.android.model.api.ApiResponse;
...
import com.ingenico.direct.sdk.client.android.model.PublicKeyResponse;
import com.ingenico.direct.sdk.client.android.model.Region;
import com.ingenico.direct.sdk.client.android.model.api.ErrorResponse;
import com.ingenico.direct.sdk.client.android.model.iin.IinDetailsRequest;
...
/**
 * Handles all communication with the Ingenico Direct Client API.
 *
...
public class C2sCommunicator implements Serializable {
	...
	/**
	 * Creates the Communicator object which handles the communication with the Ingenico Direct Client API
	 */
	...
	public ApiResponse<PaymentProductNetworkResponse> getPaymentProductNetwork(String customerId, String productId, CurrencyCode currencyCode, CountryCode countryCode, Context context, PaymentContext paymentContext) {
		...
		try {
			...
			String clientApiUrl = configuration.getBaseUrl();
			String paymentProductNetworkPath = Constants.GC_GATEWAY_RETRIEVE_PAYMENTPRODUCT_NETWORKS_PATH.replace("[cid]", configuration.getCustomerId()).replace("[pid]", productId);
