package com.ingenico.direct.sdk.client.android.asynctask;
...
import com.ingenico.direct.sdk.client.android.model.paymentproduct.FormElement;
...
import static com.ingenico.direct.sdk.client.android.model.paymentproduct.FormElement.ListType.LIST;
import static com.ingenico.direct.sdk.client.android.model.paymentproduct.PaymentProductField.Type.EXPIRYDATE;
	...
	private PaymentProduct fixProductParametersIfRequired(PaymentProduct paymentProduct) {
		...
		for (PaymentProductField field : paymentProduct.getPaymentProductFields()) {
			...
			if (EXPIRY_DATE.equals(field.getId())) {
				...
				if (field.getDisplayHints().getFormElement().getType() == LIST) {
