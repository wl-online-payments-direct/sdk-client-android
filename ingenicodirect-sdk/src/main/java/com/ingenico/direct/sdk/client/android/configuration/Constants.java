package com.ingenico.direct.sdk.client.android.configuration;
...
public class Constants {
	...
	/** Available paths on the Ingenico Direct Client API  **/
	...
	public final static String PREFERENCES_NAME = "ingenico.direct.sdk.client.android.preferences";
	...
	/** Disable/Enable logging of all requests and responses made to the Ingenico Direct Client API **/
