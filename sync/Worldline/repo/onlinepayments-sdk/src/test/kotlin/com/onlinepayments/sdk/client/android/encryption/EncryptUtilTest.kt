...
class EncryptUtilTest {
    ...
    fun testEncryptContentEncryptionKey() {
        ...
        val encryptedContentEncryptionKeyOne =
            encryptUtil.encryptContentEncryptionKey(contentEncryptionKey, publicKey)
    ...
    fun testEncryptPayload() {
        ...
        val encryptedPayload =
            encryptUtil.encryptPayload(payload, contentEncryptionKey, initializationVector)
    ...
    fun testConcatenateByteArrays() {
        ...
        val concatenatedByteArray =
            encryptUtil.concatenateByteArrays(byteArrayOne, byteArrayTwo, byteArrayThree)
