...
public class PaymentProductFieldJavaTest {

    private final PaymentProductField paymentProductFieldWithoutMask = GsonHelperJava.fromResourceJson(
        "paymentProductFieldWithoutMask.json",
        PaymentProductField.class
    );
    private final PaymentProductField paymentProductFieldWithMask = GsonHelperJava.fromResourceJson(
    ...
    private void testMaskingFor(
        FormatResult expectedFormatResult,
        String newValue,
        String oldValue,
        int indexOfChange,
        int lengthOfAffectedString,
        int lengthOfChange
    ) {
        FormatResult result = paymentProductFieldWithMask.applyMask(
            newValue,
            oldValue,
            indexOfChange
        );
        ...
        validateFormatResult(
            result,
            expectedFormatResult.getFormattedResult(),
            expectedFormatResult.getCursorIndex()
        );
    ...
    private void validateFormatResult(
        FormatResult result,
        String expectedFormattedResult,
        Integer expectedCursorIndex
    ) {
